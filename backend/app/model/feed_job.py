...
class FeedJob(Base):
    ...
    # queued | running | done | error | stopped | cancelled
    status: Mapped[str] = mapped_column(String(20), nullable=False, default="queued")
    # Cooperative control flag set by the API: "" | stop | cancel
    control: Mapped[str] = mapped_column(String(20), nullable=False, default="")
